                ...
                <ListItem key={link.text} disablePadding sx={{ mb: 1 }}>
                  <ListItemButton
                    ...
                    sx={{
                      borderRadius: 2,
                      transition: 'all 0.3s ease',
                      // Active state styling for mobile drawer
                      background: isActive 
            ...
            <ListItem disablePadding sx={{ mb: 1 }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  background: isActivePath('/profile') 
                    ? `linear-gradient(135deg, ${theme.palette.primary.main}20, ${theme.palette.secondary.main}20)`
                    : 'transparent',
                  borderLeft: isActivePath('/profile') ? `3px solid ${theme.palette.primary.main}` : 'none',
                  '&:hover': {
                    background: `linear-gradient(135deg, ${theme.palette.primary.main}20, ${theme.palette.secondary.main}20)`
                  }
                }}
              >
                ...
                <ListItemText 
                  primary="See Profile" 
                  primaryTypographyProps={{
                    fontWeight: isActivePath('/profile') ? 600 : 500,
                    color: isActivePath('/profile') ? theme.palette.primary.main : 'inherit'
                  }}
                />
              </ListItemButton>
            </ListItem>
